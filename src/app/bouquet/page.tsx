...
const wishes = [
  { id: 1, title: "Meri Jaan ❤️", flower: "🌸", text: "Meri jaan.. aapke jaisa koi ni hai.. aap bhot bhot different or special ho mere liye orr ha hamesha rhoge bi.." },
  { id: 2, title: "I am Sorry 🥺", flower: "🌺", text: "Sorry for hurting you.. but believe me Betu m aapko kbhi bi hurt ni krna chatti kbhi bi ni.. bss aapki payari si smile dekhna chahti hu.." },
  { id: 3, title: "Never Leave 🫂", flower: "🌼", text: "Please Betu merse dur mt hona kabhi bi kisi tisre ki wajh se to bilkul nii.. aapko pta h na m nii rh pati aapke bina or aap bi mere bina ni rh patee mujhe pta h jiiii....." }
];
          ...
          <AnimatePresence mode="wait">
            {step < 3 ? (
              ...
              <motion.div key="final-card" initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} exit={{ opacity: 0, scale: 0.95 }} transition={{ duration: 0.3 }} className="w-full bg-[#FDFDFD] border border-[#E8DCC4] rounded-[28px] md:rounded-[36px] lg:rounded-[40px] pt-9 pb-6 px-6 md:pt-14 md:pb-10 md:px-10 lg:pt-16 lg:pb-12 lg:px-12 shadow-[0_8px_30px_rgba(0,0,0,0.04)] flex flex-col items-center text-center relative mt-4 md:mt-8">
                ...
                <h3 className="text-[#4A3F3F] font-serif text-[18px] md:text-[26px] lg:text-[34px] tracking-wide mb-3 md:mb-5 lg:mb-6 mt-1 md:mt-2">for my meoowww ♡</h3>
                <p className="w-[85%] mx-auto text-[#8C776B] text-[10.5px] md:text-[14px] lg:text-[16px] leading-relaxed md:leading-[2] font-medium mb-6 md:mb-8 lg:mb-10 text-center">Bss aap khush raho mujhe kuch ni chaiye 😌 aapki is khushi k liye aapki Munni Badmash kuch bi kregi 😅</p>
